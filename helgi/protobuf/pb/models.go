// This is a questionable place for this package to be, might be worth moving to a different dir / package.
package generated
...
func SDPToProto(sdp *webrtc.SessionDescription) *SDP {
	return &SDP{
		Sdp:  sdp.SDP,
...
func ICECandidateToProto(candidate *webrtc.ICECandidate) *ICECandidate {
	return &ICECandidate{
...
func (candidate *ICECandidate) ToPion() *webrtc.ICECandidate {
